...
class ArticleHeadlineBusinessListBloc extends Bloc<ArticleListEvent, ArticleListState> {
  final GetHeadlineBusinessArticles getHeadlineBusinessArticles; 
  ArticleHeadlineBusinessListBloc(this.getHeadlineBusinessArticles) : super(ArticleListEmpty()) {
